		...
		return { //this:ActionBasciFsm
				...
				state("waitCmdAtObstacle") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t08",targetState="handleEnvCond",cond=whenEvent("envCond"))
					transition(edgeName="t09",targetState="handleModelChanged",cond=whenEvent("local_robotModelChanged"))
				}	 
			}
		}
}
