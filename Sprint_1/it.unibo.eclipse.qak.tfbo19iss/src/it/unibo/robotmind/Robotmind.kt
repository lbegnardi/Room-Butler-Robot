		...
		return { //this:ActionBasciFsm
				...
				state("waitCmd") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t03",targetState="handleEnvCond",cond=whenEvent("envCond"))
					transition(edgeName="t04",targetState="handleSonarRobot",cond=whenEvent("sonarRobot"))
					transition(edgeName="t05",targetState="handleModelChanged",cond=whenEvent("local_robotModelChanged"))
				}	 
				...
				state("waitCmdAtObstacle") { //this:State
					...
					transition(edgeName="t07",targetState="handleModelChanged",cond=whenEvent("local_robotModelChanged"))
				}	 
			}
		}
}
