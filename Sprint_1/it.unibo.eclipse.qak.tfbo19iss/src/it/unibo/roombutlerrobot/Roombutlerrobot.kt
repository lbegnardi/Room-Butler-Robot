		...
		return { //this:ActionBasciFsm
				...
				state("waitCmd") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t00",targetState="prepareTheRoomInit",cond=whenDispatch("prepare"))
					transition(edgeName="t01",targetState="addFoodOnTableInit",cond=whenDispatch("addFood"))
					transition(edgeName="t02",targetState="clearTheRoomInit",cond=whenDispatch("clear"))
				}	 
				...
				state("waitPrepare") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t03",targetState="prepareTheRoomContinue",cond=whenDispatch("goalOk"))
					transition(edgeName="t04",targetState="prepareTheRoomContinue",cond=whenEvent("roomModelChanged"))
				}	 
				state("prepareTheRoomContinue") { //this:State
					action { //it:State
						...
						if( checkMsgContent( Term.createTerm("goalOk(X)"), Term.createTerm("goalOk(home)"), 
						                        currentMsg.msgContent()) ) { //set msgArgList
								actionDone = true
								forward("prepareDone", "prepareDone" ,"emulatedmaitre" ) 
						}
				...
				state("addFoodOnTableInit") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t05",targetState="checkFridgeAnswer",cond=whenDispatch("answer"))
				}	 
					...
					action { //it:State
						...
						if( checkMsgContent( Term.createTerm("answer(A)"), Term.createTerm("answer(no)"), 
								...
								CurObject = ""
										      ...
										      GoalY = ""
											  actionDone = true
								forward("warning", "warning" ,"emulatedmaitre" ) 
						}
					}
					 transition( edgeName="goto",targetState="waitCmd", cond=doswitchGuarded({actionDone}) )
				...
				state("waitAddFood") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t06",targetState="addFoodOnTheTableContinue",cond=whenDispatch("goalOk"))
					transition(edgeName="t07",targetState="addFoodOnTheTableContinue",cond=whenEvent("roomModelChanged"))
				}	 
				state("addFoodOnTheTableContinue") { //this:State
					action { //it:State
						...
						if( checkMsgContent( Term.createTerm("goalOk(X)"), Term.createTerm("goalOk(home)"), 
						                        currentMsg.msgContent()) ) { //set msgArgList
								actionDone = true
								forward("addDone", "addDone" ,"emulatedmaitre" ) 
						}
						if( checkMsgContent( Term.createTerm("modelChanged(RES,VALUE)"), Term.createTerm("modelChanged(fridge,remove(_))"), 
						                        currentMsg.msgContent()) ) { //set msgArgList
				...
				state("clearTheRoomInit") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t08",targetState="checkTableState",cond=whenEvent("modelState"))
				}	 
				...
				state("waitClear") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t09",targetState="clearTheRoomContinue",cond=whenDispatch("goalOk"))
					transition(edgeName="t010",targetState="clearTheRoomContinue",cond=whenEvent("roomModelChanged"))
				}	 
				state("clearTheRoomContinue") { //this:State
					action { //it:State
						...
						if( checkMsgContent( Term.createTerm("goalOk(X)"), Term.createTerm("goalOk(home)"), 
						                        currentMsg.msgContent()) ) { //set msgArgList
								actionDone = true
								forward("clearDone", "clearDone" ,"emulatedmaitre" ) 
						}
