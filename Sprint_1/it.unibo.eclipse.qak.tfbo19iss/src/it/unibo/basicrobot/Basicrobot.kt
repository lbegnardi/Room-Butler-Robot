		...
		return { //this:ActionBasciFsm
				state("s0") { //this:State
					action { //it:State
						...
						itunibo.robot.robotSupport.sendMsg( "msg(a)"  )
						delay(700) 
						itunibo.robot.robotSupport.sendMsg( "msg(d)"  )
						delay(700) 
						itunibo.robot.robotSupport.sendMsg( "msg(h)"  )
					}
				...
				state("waitCmd") { //this:State
					...
					transition(edgeName="t012",targetState="emitEventForAppl",cond=whenEvent("sonarData"))
				}	 
				state("handleRobotCmd") { //this:State
					action { //it:State
						println("$name in ${currentState.stateName} | $currentMsg")
						if( checkMsgContent( Term.createTerm("robotCmd(CMD)"), Term.createTerm("robotCmd(MSG)"), 
						                        currentMsg.msgContent()) ) { //set msgArgList
								itunibo.robot.robotSupport.sendMsg( "msg(${payloadArg(0)})"  )
						}
					}
					 transition( edgeName="goto",targetState="waitCmd", cond=doswitch() )
				}	 
