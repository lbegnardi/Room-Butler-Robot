		...
		return { //this:ActionBasciFsm
				...
				state("waitCmd") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t011",targetState="createPlan",cond=whenDispatch("goalUpdate"))
				}	 
				...
				state("doForwardMove") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t012",targetState="handleStepOk",cond=whenDispatch("stepOk"))
					transition(edgeName="t013",targetState="handleStepFail",cond=whenDispatch("stepFail"))
				}	 
