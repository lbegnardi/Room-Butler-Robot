...
*/ 
var msgNum=1;
sendMsgAfterTime("msg(robotCmd,dispatch,js,robot,turnRight," + msgNum++ +")", 500);
sendMsgAfterTime("msg(robotCmd,dispatch,producer,robot,turnLeft," + msgNum++ +")", 1000);
sendMsgAfterTime("msg(robotCmd,dispatch,producer,robot,forward,"   + msgNum++ +")", 1500);
sendMsgAfterTime("msg(robotCmd,dispatch,producer,robot,backward," + msgNum++ +")", 2500);
sendMsgAfterTime("msg(robotCmd,dispatch,producer,robot,stop," + msgNum++ +")", 3500);
