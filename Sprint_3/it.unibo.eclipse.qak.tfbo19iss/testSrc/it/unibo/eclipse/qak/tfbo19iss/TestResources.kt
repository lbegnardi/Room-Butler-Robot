...
class TestResources {
	...
	fun systemSetUp() {
		...
		try {
			println("%%%%%%%%%%%%%% Sprint 3 TestResources starting Mqtt Client")
	...
	@After
	fun terminate() {
		println("%%%%%%% Sprint 3 TestResources terminate ")
		try {
	...
	@Test
	fun sprint1Test() {
		println("%%%%%%% Sprint 3 Functional TestResources starts ")
		stop()
		reactivate()
	}
	
	fun stop() {
		println("%%%%%%% Sprint 3 TestResources stop command")
		sendCmd("prepare", "")
		delay(5000)
		emitEvent("stop")
		delay(5000)
	...
	fun reactivate() {
		println("%%%%%%% Sprint 3 TestResources reactivate command")
		emitEvent("resume")
		delay(40000)
		solveCheckGoal(resource!!, "model( actuator, robot, state( stopped ) )")
