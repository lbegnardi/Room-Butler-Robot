		...
		return { //this:ActionBasciFsm
				state("s0") { //this:State
					action { //it:State
						...
						itunibo.coap.fridgeResourceCoap.create(myself ,"fridge" )
					}
				...
				state("waitCmd") { //this:State
					...
					transition(edgeName="t01",targetState="exposeModel",cond=whenDispatch("expose"))
					transition(edgeName="t02",targetState="updateModel",cond=whenDispatch("modelUpdate"))
				}	 
				...
				state("exposeModel") { //this:State
					action { //it:State
						itunibo.fridge.fridgeModelSupport.exposeFridgeModel(myself)
					}
					 transition( edgeName="goto",targetState="waitCmd", cond=doswitch() )
				}	 
