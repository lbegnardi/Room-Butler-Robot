		...
		return { //this:ActionBasciFsm
				...
				state("doMoveForward") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t012",targetState="endDoMoveForward",cond=whenTimeout("local_tout_onestepahead_doMoveForward"))   
					transition(edgeName="t013",targetState="stepFail",cond=whenEvent("obstacle"))
				}	 
