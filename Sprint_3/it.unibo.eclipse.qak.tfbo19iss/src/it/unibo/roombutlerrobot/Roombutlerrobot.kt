	...
	override fun getBody() : (ActorBasicFsm.() -> Unit){
		...
		return { //this:ActionBasciFsm
				...
				state("waitPrepare") { //this:State
					...
					transition(edgeName="t05",targetState="stopTask",cond=whenEvent("stop"))
					transition(edgeName="t06",targetState="prepareTheRoomContinue",cond=whenEvent("roomModelChanged"))
				}	 
				state("prepareTheRoomContinue") { //this:State
					action { //it:State
						...
						if( checkMsgContent( Term.createTerm("goalOk(X)"), Term.createTerm("goalOk(fridge)"), 
						                        currentMsg.msgContent()) ) { //set msgArgList
								forward("modelUpdate", "modelUpdate(fridge,remove($CurObject))" ,"resourcemodel" ) 
						}
				...
				state("addFoodOnTableInit") { //this:State
					action { //it:State
						...
						if( checkMsgContent( Term.createTerm("addFood(X)"), Term.createTerm("addFood(F)"), 
						                        currentMsg.msgContent()) ) { //set msgArgList
								forward("request", "request(${payloadArg(0)})" ,"resourcemodel" ) 
								CurObject = "${payloadArg(0)}" 
						}
					}
					 transition(edgeName="t07",targetState="checkFridgeAnswer",cond=whenDispatch("answer"))
				}	 
				...
				state("waitAddFood") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t08",targetState="addFoodOnTheTableContinue",cond=whenDispatch("goalOk"))
					transition(edgeName="t09",targetState="stopTask",cond=whenEvent("stop"))
					transition(edgeName="t010",targetState="addFoodOnTheTableContinue",cond=whenEvent("roomModelChanged"))
				}	 
				...
				state("clearTheRoomInit") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t011",targetState="checkTableState",cond=whenEvent("modelState"))
				}	 
				...
				state("waitClear") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t012",targetState="clearTheRoomContinue",cond=whenDispatch("goalOk"))
					transition(edgeName="t013",targetState="stopTask",cond=whenEvent("stop"))
					transition(edgeName="t014",targetState="clearTheRoomContinue",cond=whenEvent("roomModelChanged"))
				}	 
				state("clearTheRoomContinue") { //this:State
					action { //it:State
						...
						if( checkMsgContent( Term.createTerm("goalOk(X)"), Term.createTerm("goalOk(fridge)"), 
						                        currentMsg.msgContent()) ) { //set msgArgList
								forward("modelUpdate", "modelUpdate(fridge,add($CurObject))" ,"resourcemodel" ) 
						}
				...
				state("waitReactivation") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t015",targetState="resumeTask",cond=whenDispatch("resume"))
				}	 
				state("resumeTask") { //this:State
					action { //it:State
						emit("local_resume", "resume($CurTask)" ) 
					}
					 transition( edgeName="goto",targetState="waitTaskResumed", cond=doswitch() )
				}	 
				state("waitTaskResumed") { //this:State
					action { //it:State
						println("WAIT TASK RESUMED")
					}
					 transition(edgeName="t016",targetState="waitPrepare",cond=whenEvent("local_prepareResumed"))
					transition(edgeName="t017",targetState="waitAddFood",cond=whenEvent("local_addFoodResumed"))
					transition(edgeName="t018",targetState="waitClear",cond=whenEvent("local_clearResumed"))
				}	 
			}
		}
}
