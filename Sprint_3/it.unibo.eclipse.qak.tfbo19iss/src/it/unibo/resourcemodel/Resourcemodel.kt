		...
		return { //this:ActionBasciFsm
				state("s0") { //this:State
					action { //it:State
						...
						itunibo.coap.client.coapClientResModel.createClient(myself ,"localhost", 5683, "fridge" )
					}
				...
				state("waitMsg") { //this:State
					...
					transition(edgeName="t04",targetState="sendRequest",cond=whenDispatch("request"))
					transition(edgeName="t05",targetState="emitWarning",cond=whenDispatch("warning"))
				}	 
				state("updateModel") { //this:State
					action { //it:State
						...
						if( checkMsgContent( Term.createTerm("modelUpdate(TARGET,VALUE)"), Term.createTerm("modelUpdate(fridge,V)"), 
						                        currentMsg.msgContent()) ) { //set msgArgList
								itunibo.coap.client.coapClientResModel.put( payloadArg(1)  )
						}
				...
				state("sendRequest") { //this:State
					action { //it:State
						if( checkMsgContent( Term.createTerm("request(F)"), Term.createTerm("request(F)"), 
						                        currentMsg.msgContent()) ) { //set msgArgList
								itunibo.coap.client.coapClientResModel.synchGet( payloadArg(0)  )
						}
					}
					 transition( edgeName="goto",targetState="waitMsg", cond=doswitch() )
				}	 
